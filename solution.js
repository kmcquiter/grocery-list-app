...
let listBtn = document.querySelectorAll("input");
...
/* 2.3) When the user clicks the TOTAL button:
        ...
        3. Add the count to the page by setting the textContent of #item-count */
              ...
              function getTotal(){
                ...
                let groceryList = document.querySelectorAll("#grocery-list");
                let numOfGroceries = groceryList.length;
                document.querySelectorAll("#item-count").textContent = numOfGroceries;
                }
